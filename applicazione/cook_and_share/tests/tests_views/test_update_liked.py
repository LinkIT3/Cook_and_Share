...
class TestUpdateLiked(TestCase):
    ...
    def test_get_request(self):
        response = self.client.get(reverse('toggle_liked'))
    ...
    def test_no_data(self):
        response = self.client.post(reverse('toggle_liked'))
